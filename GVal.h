...
public:
	...
	void setMultiArray();
	void setMultiArray(size_t i0, int entryType);
	...
	void setMultiArrayFromData(size_t i0, int entryType, void *data, bool borrowData = false);
	void setMultiArrayFromData(size_t i0, size_t i1, int entryType, void *data, bool borrowData = false);
	void setMultiArrayFromData(size_t i0, size_t i1, size_t i2, int entryType, void *data, bool borrowData = false);
	void setMultiArrayFromData(size_t i0, size_t i1, size_t i2, size_t i3, int entryType, void *data, bool borrowData = false);
